...
<template>
    <div class="layout-breadcrumb-seting">
        <el-drawer v-model="getThemeConfig.isDrawer" :title="$t('message.layout.configTitle')" direction="rtl"
            ...
            <el-scrollbar class="layout-breadcrumb-seting-bar">
                ...
                <div class="layout-breadcrumb-seting-bar-flex">
                    ...
                    <div class="layout-breadcrumb-seting-bar-flex-value">
                        <el-color-picker v-model="getThemeConfig.primary" :predefine="predefinePrimaryColors" size="default"
                ...
                <div class="layout-breadcrumb-seting-bar-flex">
                    ...
                    <div class="layout-breadcrumb-seting-bar-flex-value">
                        <el-color-picker v-model="getThemeConfig.topBar" :predefine="predefineTopBarBgColors" size="default"
                ...
                <div class="layout-breadcrumb-seting-bar-flex">
                    ...
                    <div class="layout-breadcrumb-seting-bar-flex-value">
                        <el-color-picker v-model="getThemeConfig.topBarColor" :predefine="predefineFontColors"
                            size="default" @change="onBgColorPickerChange('topBarColor')" />
                    </div>
                </div>
                ...
                <div class="layout-breadcrumb-seting-bar-flex">
                    ...
                    <div class="layout-breadcrumb-seting-bar-flex-value">
                        <el-color-picker v-model="getThemeConfig.menuBar" :predefine="predefineMenuBarBgColors"
                            size="default" @change="onBgColorPickerChange('menuBar')" />
                    </div>
                </div>
                <div class="layout-breadcrumb-seting-bar-flex">
                    <div class="layout-breadcrumb-seting-bar-flex-label">
                    ...
                    <div class="layout-breadcrumb-seting-bar-flex-value">
                        <el-color-picker v-model="getThemeConfig.menuBarColor" :predefine="predefineFontColors"
                            size="default" @change="onBgColorPickerChange('menuBarColor')" />
                    </div>
                </div>
                <div class="layout-breadcrumb-seting-bar-flex">
                    <div class="layout-breadcrumb-seting-bar-flex-label">
                ...
                <div class="layout-breadcrumb-seting-bar-flex"
                    ...
                    <div class="layout-breadcrumb-seting-bar-flex-value">
                        <el-color-picker v-model="getThemeConfig.columnsMenuBar"
                            :predefine="predefineColumnsMenuBarBgColors" size="default"
                ...
                <div class="layout-breadcrumb-seting-bar-flex"
                    ...
                    <div class="layout-breadcrumb-seting-bar-flex-value">
                        <el-color-picker v-model="getThemeConfig.columnsMenuBarColor" :predefine="predefineFontColors"
                ...
                <div class="layout-breadcrumb-seting-bar-flex mt15">
                    ...
                    <div class="layout-breadcrumb-seting-bar-flex-value">
                        <el-select v-model="getThemeConfig.animation" placeholder="请选择" placement="bottom-end"
                ...
                <div class="layout-breadcrumb-seting-bar-flex mb27 mt15"
                    :style="{ opacity: getThemeConfig.layout !== 'columns' ? 0.5 : 1 }">
                    <div class="layout-breadcrumb-seting-bar-flex-label">
                ...
                <div class="copy-config">
                    ...
                    <el-button ref="copyConfigBtnRef" size="default" class="copy-config-btn" type="primary"
